...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nTodos os funcionários e clientes finalizaram suas operações\n");
        ...
        for (Funcionario funcionario : funcionarios) {
            ...
            System.out.println(funcionario.getNome() + " Conta investimentos : R$" + String.format("%.2f\n", funcionario.getSaldoInvestimentos()));
        }
        ...
        for (Cliente cliente : clientes) {
            ...
            System.out.println(cliente.getnomeCliente() + " Conta: R$" + String.format("%.2f\n", cliente.consultaSaldo()));

        }

        System.out.println("----------Saldo Lojas----------\n");
        System.out.println(LojaX.getNomeLoja() + " Conta: R$" + String.format("%.2f\n", LojaX.consultaSaldo()));
        System.out.println(LojaY.getNomeLoja() + " Conta: R$" + String.format("%.2f", LojaY.consultaSaldo()));
